...
### Next Runtime Test
- Smoke-test `2.0.19-dev` structural cleanup before any P4 runtime changes: confirm no Lua errors, confirm the UI reports `2.0.19-dev`, open Outfitter normally, perform a normal saved-outfit swap, and make one manual gear change to confirm reconciliation still behaves as in the accepted `2.0.18-dev` baseline.
